...
public class Payload {
    private static Hashtable<String, FrontierDataObject> htFdo = new Hashtable<String,
            FrontierDataObject>();
    ...
    protected Payload(Command a_cmd, DbConnectionMgr a_dbm) throws Exception {
        ...
        if ((ttl != null) && (ttl.equals("forever")))
            emptyiserror = true;
        else
            emptyiserror = false;
        ...
        switch (cmd.cmd_domain) {
            case Command.CMD_GET:
                ...
                try {
                    ...
                    MDC.put("dbSize", String.valueOf(full_size));
